    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="brand">
        <a href="index.html">
          <img src="{{asset('klorofil/assets/img/logo-white.png')}}" alt="Klorofil/assets Pro Logo" class="img-responsive logo">
        </a>
      </div>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="{{asset('klorofil/assets/img/user.png')}}" alt="Avatar">
                <span>Samuel</span>
              </a>
